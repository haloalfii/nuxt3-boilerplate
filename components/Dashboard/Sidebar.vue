<template>
    <aside
        ...
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            ...
            <!-- Menu Loop -->
            <ul v-for="(menus, index) of getMenu" :key="'index-menus-' + index" class="space-y-2"
                ...
                <li v-for="(littleMenu, indexLittle) of menus" :key="'index-littleMenu-' + indexLittle">
                    <!-- Normal Menu -->
                    <a v-if="littleMenu.child.length == 0" href="#"
                    ...
                    <template v-else>
                        <button type="button"
                            ...
                            :aria-controls="`dropdown-${littleMenu.key}`" :data-collapse-toggle="`dropdown-${littleMenu.key}`">
                            <svg aria-hidden="true"
...
const { getMenu } = storeToRefs(sidebar)
</script>
